...
// Importa o serviço 'ApiQuotationService' que gerencia a comunicação com a API para registro de usuários.
...
export class RegisterFormComponent {
  ...
  constructor(private fb: FormBuilder, private router: Router, private apiService: ApiQuotationService) {
    // Injeta o FormBuilder, o Router e o ApiQuotationService no construtor.
