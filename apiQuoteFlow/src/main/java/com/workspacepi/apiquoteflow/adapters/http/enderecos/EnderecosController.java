...
//  Método get para a rota de uma cotação especifica.
    ...
    public ResponseEntity<Endereco> cadastrarEndereco(@RequestBody EnderecosCreateCommand enderecosCreateCommand) throws Exception {
    ...
    public ResponseEntity<Endereco> modificarEndereco(@RequestBody EnderecosUpdateCommand enderecosUpdateCommand, @PathVariable String id_endereco) throws Exception {
